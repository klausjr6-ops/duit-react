DUIT — Export/Import Backup + Forgot Password + Performance Optimization
Tanggal: 11 Juli 2026

Isi update terbaru:

1) Export / Import Backup
- Tambah section "Backup Data" di Account modal.
...
3) Optimasi lanjutan bundle/chunk
...
rm -rf /tmp/duit-export-import-backup-v1-extract
unzip -o ~/Downloads/duit-export-import-backup-v1.zip -d /tmp/duit-export-import-backup-v1-extract
rsync -av /tmp/duit-export-import-backup-v1-extract/duit-export-import-backup-v1/ ./
...
git commit -m "feat: add backup export import"
